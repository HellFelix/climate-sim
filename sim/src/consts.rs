...
pub const DX: f32 = 1.;
pub const DY: f32 = 1.;
pub const DTHETA: f32 = 2. * PI * DX / WIDTH as f32;
pub const DPHI: f32 = PI * DY / HEIGHT as f32;
pub const KAPPA: f32 = 1.;
const CFL: f32 = 0.01;
pub const DIFFUSION_DT: f32 = CFL * DPHI * DTHETA / (KAPPA * 20.);
