...
\begin{document}
  ...
  \newpage
   ...
   \begin{figure}[h!]
     ...
     \caption{Tempraturen för prob A och B för balnding I och II vid avstond $\gamma_1$ till $\gamma_{10}$}
     \label{fig:gamma1_till_10}
   \end{figure} 
   \begin{figure}[h!]
     \centering
     \includegraphics[width=0.8\textwidth]{figur2_gamma1_vs_Phi.png} % eller utan .png
     \caption{Tempraturen för prob A och B och blanding I och II vid avstånd $\gamma_1$ som en funktion av dess blandningsförhollande $\Phi$}
...
\newpage
 ...
 \section{Diskussion}
    Som vi kan se från tabell 1 och 2 är tempraturen vid $\alpha$ och $\beta$ nära rumstempratur vilket stämmer överens med teroin då all reaktion sker vid en flammfront och dessa punkter är inannför den. 
    I dessa punkter kommer värme endast från strålningen från reaktionsfronten. I punkt $\beta$ är det varmare än rumstempratur vilket delvis kan förklaras av att den är närmre flammfronten och det strålar därför mer men det beror troligtvis mestadels på fel i mätningen som att proberna har en volym och därför kan de ha rört vid flamfronten.
    Detta sryrks av det faktum att prob B hade mindre skillnad mellan de två punkterna, se tabell 1, och det var den mindre proben.
    \\
    Vidare har vi vid teroetiska beräkningar kommit fram till att flammtempraturen borde ligga kring 2300 K vilket skiljer sig stort från vårt uppmätta resultat. Det fins många skäl till denna diferans. Främst så mäter inte instrumentet tempraturen på flamamn utan tempraturen på proben och eftersom den strålar kommer den inte nå flammans tempratur vilket står för en diferans på mellan 100 och 200 K. Denna diferans ökar med arean av proben och $T⁴$ vilket kan ses i Figur 5 (prob B är mindre än A).
    Utöver det har vi i teroin antagit total förbränning av reaktanterna vilket inte riktigt stämmer.
    Dessutom har vi antagit adiabatisk reaktion vilket inte heller riktigt gäller. Utöver detta fins alltid den mänskliga faktorn, instrumetntet mäter som vi sagt tidigare endast tempraturen på proben och om den inte hunnit nå gämnvikt med flamman kommer mätvärldena vara felaktiga.
    \\
    Andra intresanta saker vi kan se är att den stokimetriska flamman ($\Phi \approx 1.0$) har högre tempratur vid $\gamma_1$ eftersom mer brensle förbräns vid flamfronten i en stökometrisk blandning än en bränslerik. Den bränslerika kommer inte förbrenans helt förän den får tillgång till mer syre vilket ger den en halo där mer energi frigörs.
    Detta svarar på varför tempraturen först ökar när vi rör oss bort från flamfronent, se de gröan mätvärldena på figur 4, vi verkar nå ett maxima vid $\gamma_7$ eller $\gamma_8$ vilket troligtvis är var halon slutar och alltså där all energi frigjorts hoss den brenslerika blandingen.
